package com.mrgao.androiduidesign.recyclerview.adapter;
...
import com.mrgao.androiduidesign.recyclerview.holder.HeaderViewHolder;
import com.mrgao.androiduidesign.recyclerview.holder.ItemViewHolder;
import com.mrgao.androiduidesign.recyclerview.holder.TabViewHolder;
...
public class ComplexAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_ITEM_TAB:
                return new TabViewHolder(inflater.inflate(R.layout.re_item_tab, parent, false));
